...
async function getStaticProps() {
  // fetch data from api
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://fenix:MR5nBGrPWUY0PiPi@reactvsnext.j9lwg.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
